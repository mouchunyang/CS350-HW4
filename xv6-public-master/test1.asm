...
main(int argc, char *argv[]){
  ...
  37:	75 ef                	jne    28 <main+0x28>
	...
	wait();
  39:	e8 ec 02 00 00       	call   32a <wait>
	exit();
  3e:	e8 df 02 00 00       	call   322 <exit>
  43:	8d 75 d4             	lea    -0x2c(%ebp),%esi
  46:	bb 2c 01 00 00       	mov    $0x12c,%ebx
  4b:	90                   	nop
  4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			int fd=open("test1_2.c", O_RDONLY);
  50:	83 ec 08             	sub    $0x8,%esp
  53:	6a 00                	push   $0x0
  55:	68 c8 07 00 00       	push   $0x7c8
  5a:	e8 03 03 00 00       	call   362 <open>
			read(fd,buf,sizeof buf);
  5f:	83 c4 0c             	add    $0xc,%esp
  62:	6a 14                	push   $0x14
  64:	56                   	push   %esi
  65:	50                   	push   %eax
  66:	e8 cf 02 00 00       	call   33a <read>
		for(int i=0;i<300;i++){
  6b:	83 c4 10             	add    $0x10,%esp
  6e:	83 eb 01             	sub    $0x1,%ebx
  71:	75 dd                	jne    50 <main+0x50>
  73:	eb c4                	jmp    39 <main+0x39>
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
...
int fib(int i){
  88:	83 ec 1c             	sub    $0x1c,%esp
  8b:	8b 45 08             	mov    0x8(%ebp),%eax
	if(i<2){
  8e:	83 f8 01             	cmp    $0x1,%eax
  91:	7e 2e                	jle    c1 <fib+0x41>
  93:	8d 50 fe             	lea    -0x2(%eax),%edx
  96:	8d 78 fd             	lea    -0x3(%eax),%edi
  99:	8d 58 ff             	lea    -0x1(%eax),%ebx
  9c:	89 d0                	mov    %edx,%eax
  9e:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  a1:	83 e0 fe             	and    $0xfffffffe,%eax
  a4:	29 c7                	sub    %eax,%edi
		return fib(i-1)+fib(i-2);
  a6:	83 ec 0c             	sub    $0xc,%esp
  a9:	53                   	push   %ebx
  aa:	83 eb 02             	sub    $0x2,%ebx
  ad:	e8 ce ff ff ff       	call   80 <fib>
  b2:	83 c4 10             	add    $0x10,%esp
  b5:	01 c6                	add    %eax,%esi
	if(i<2){
  b7:	39 fb                	cmp    %edi,%ebx
  b9:	75 eb                	jne    a6 <fib+0x26>
  bb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  be:	83 e0 01             	and    $0x1,%eax
}
  c1:	8d 65 f4             	lea    -0xc(%ebp),%esp
 ...
 3d9:	85 d2                	test   %edx,%edx
{
 ...
 407:	f7 f1                	div    %ecx
 409:	0f b6 92 dc 07 00 00 	movzbl 0x7dc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	e9 8f fe ff ff       	jmp    4b8 <printf+0x48>
          s = "(null)";
 629:	bb d2 07 00 00       	mov    $0x7d2,%ebx
        while(*s != 0){
