...
main(int argc, char *argv[]){
  ...
  11:	83 ec 28             	sub    $0x28,%esp
	...
	if(fork()!=0){
  14:	e8 41 03 00 00       	call   35a <fork>
  19:	85 c0                	test   %eax,%eax
  1b:	74 3e                	je     5b <main+0x5b>
  ...
  41:	53                   	push   %ebx
  42:	68 08 08 00 00       	push   $0x808
  47:	6a 01                	push   $0x1
  49:	e8 62 04 00 00       	call   4b0 <printf>
  4e:	83 c4 10             	add    $0x10,%esp
	...
	wait();
  51:	e8 14 03 00 00       	call   36a <wait>
	//if(pid==getpid()){
		//wait();
	//}
	exit();
  56:	e8 07 03 00 00       	call   362 <exit>
  5b:	8d 75 d4             	lea    -0x2c(%ebp),%esi
		fork();
  5e:	bf 90 01 00 00       	mov    $0x190,%edi
		fork();
  63:	e8 f2 02 00 00       	call   35a <fork>
		fork();
  68:	e8 ed 02 00 00       	call   35a <fork>
		fork();
  6d:	e8 e8 02 00 00       	call   35a <fork>
  72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  78:	bb 03 00 00 00       	mov    $0x3,%ebx
				int fd=open("test1_2.c", O_RDONLY);
  7d:	83 ec 08             	sub    $0x8,%esp
  80:	6a 00                	push   $0x0
  82:	68 16 08 00 00       	push   $0x816
  87:	e8 16 03 00 00       	call   3a2 <open>
				read(fd,buf,sizeof buf);
  8c:	83 c4 0c             	add    $0xc,%esp
  8f:	6a 14                	push   $0x14
  91:	56                   	push   %esi
  92:	50                   	push   %eax
  93:	e8 e2 02 00 00       	call   37a <read>
			for (int j = 0; j < 3; ++j){
  98:	83 c4 10             	add    $0x10,%esp
  9b:	83 eb 01             	sub    $0x1,%ebx
  9e:	75 dd                	jne    7d <main+0x7d>
			sleep(1);
  a0:	83 ec 0c             	sub    $0xc,%esp
  a3:	6a 01                	push   $0x1
  a5:	e8 48 03 00 00       	call   3f2 <sleep>
		for(int i=0;i<400;i++){
  aa:	83 c4 10             	add    $0x10,%esp
  ad:	83 ef 01             	sub    $0x1,%edi
  b0:	75 c6                	jne    78 <main+0x78>
		wait();
  b2:	e8 b3 02 00 00       	call   36a <wait>
		wait();
  b7:	e8 ae 02 00 00       	call   36a <wait>
  bc:	eb 93                	jmp    51 <main+0x51>
  be:	66 90                	xchg   %ax,%ax
 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 28 08 00 00 	movzbl 0x828(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 20 08 00 00       	mov    $0x820,%ebx
        while(*s != 0){
